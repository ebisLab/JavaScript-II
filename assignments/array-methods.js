...
// ticketPriceTotal = runners.reduce((old, newrunner) => newrunner.donation + old, 0) //old=integer   || newrunner = runner

ticketPriceTotal = runners.reduce(function(old,newrunner){
    return newrunner.donation + old;
}, 0)
